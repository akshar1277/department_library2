  ...
  return (
    ...
    <div className="about about--style3 padding-top pt-xl-0" >
		<div className="container" >
			<div className="section__wrapper wow fadeInUp" data-wow-duration="1.5s" style={{ borderRadius : '10'}}>
				<form action="#"  style={{background : '#3a3a3b'}}>
					<div className="banner__list">
						<div className="row align-items-center row-cols-xl-3 row-cols-lg-3 row-cols-sm-2 row-cols-1">
							...
							<div className="col-6">
								<label style={{color : 'white'}}>Internal Guide</label>
								<div className="banner__inputlist">
									<select>
